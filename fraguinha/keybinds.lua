...
function M.setup(config)
	config.keys = {
		...
		-- Navigation
		{
			key = "LeftArrow",
			mods = "CTRL|SHIFT",
			action = wezterm.action.EmitEvent("fraguinha.ActivatePaneDirection.Left"),
		},
		{
			key = "DownArrow",
			mods = "CTRL|SHIFT",
			action = wezterm.action.EmitEvent("fraguinha.ActivatePaneDirection.Down"),
		},
		{
			key = "UpArrow",
			mods = "CTRL|SHIFT",
			action = wezterm.action.EmitEvent("fraguinha.ActivatePaneDirection.Up"),
		},
		{
			key = "RightArrow",
			mods = "CTRL|SHIFT",
			action = wezterm.action.EmitEvent("fraguinha.ActivatePaneDirection.Right"),
		},
		-- Vim
